            ...
            <div class="cell">
                <div class="grid-x grid-padding-x grid-margin-x">
                    ...
                    <div class="large-6 medium-6 cell theme-cell" style="text-align: center;">
                        ...
                        <p style="text-align: left;">We believe that some teachers won't read the eligibility content, and some teachers aren't sure what local authority their school is a part of, so we'd like to test an eligibility checker in Beta. This may be a more effective filter of ineligible teachers.
                        </p>
                        <div class="grid-x grid-padding-x">

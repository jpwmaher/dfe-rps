    ...
    <div class="grid-container">
        ...
        <div class="grid-x grid-padding-x grid-margin-x">
            <div class="large-6 medium-6 cell theme-cell wow fadeInRight" style="text-align: center;">
                ...
                <p style="text-align: left;">The teaching <span data-tooltip tabindex="1" title="Teachers who qualified via PGCE, School Direct and SCITT teacher training routes are awarded a specialist teaching qualification. This route objectively identifies specialist Physics teachers from other Science teachers, thus aligning better with the policy’s intent.">qualification route</span> is a better eligibility criterion option than the proposed 50% teaching rule eligibility criterion in the draft policy. </p>
